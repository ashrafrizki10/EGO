...
export function CharacterCard({ character }: CharacterCardProps) {
  return (
    <article className="group overflow-hidden rounded-[2rem] border border-slate-800/70 bg-slate-900/80 transition hover:-translate-y-1 hover:border-sky-500/30 hover:bg-slate-950/90">
      <CharacterAvatar character={character} className="h-64 w-full" />
      <div className="p-6">
